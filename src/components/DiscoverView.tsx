  ...
  return (
    <div className="group w-[128px] shrink-0">
      ...
      >
        ...
        {saved ? (
          <div className="absolute left-1.5 top-1.5 flex items-center gap-1 rounded-md bg-emerald-500/85 px-1.5 py-0.5 text-[10px] font-semibold text-white">
      ...
      <div className="flex items-center justify-between gap-3">
        <div className="flex flex-wrap gap-1.5">
          {GENRE_ROWS.map((g) => (
            <button
              key={g.id}
              onClick={() => openAdvanced(g.id)}
              className="rounded-full bg-white/[0.06] px-2.5 py-1 text-[11px] text-white/75 transition hover:bg-white/[0.12] hover:text-white"
            >
              {g.name}
            </button>
          ))}
        ...
        <button
          ...
          className="inline-flex shrink-0 items-center gap-1.5 rounded-md bg-white/[0.08] px-3 py-1.5 text-[13px] font-medium text-white/90 transition hover:bg-white/[0.14]"
        >
